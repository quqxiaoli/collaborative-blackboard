...
func MigrateDB(db *gorm.DB) error {
    ...
    logrus.Info("Running AutoMigrate for all models...")
    err := db.AutoMigrate(
        &domain.User{},     // 让 GORM 处理 User 表
        &domain.Room{},     // 让 GORM 处理 Room 表
        &domain.Action{},
        &domain.Snapshot{},
    )
    if err != nil {
    ...
    logrus.Info("Database migration completed successfully using AutoMigrate")
    return nil
}
